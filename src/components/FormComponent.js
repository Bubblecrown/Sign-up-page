    ...
    return (
      ...
      >
        ...
        "
          ...
          >
            <span className="absolute block h-full bg-[#1e7f55] -bottom-1 border-[#1e7f55] border rounded-lg inset-x-0 px-10 "></span>
            <span className="relative block xl:px-30 xl:py-4 lg:py-4 ss:px-4 ss:py-3  bg-[color:var(--Green)] rounded-lg transition transform duration-150 active:translate-y-1 s:text-sm ss:text-xs lg:text-[16px]">
